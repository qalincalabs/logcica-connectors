...
const openBatraProduct = {
  ...
  "s:description": [
    {
      "@value":
        "Jus de pomme - 98% Pur jus - Sans sucre ajouté - Sans conservateur - Sans colorants - Non dilué - Naturellement trouble - Jus pasteurisé.",
      "@language": "fr",
    },
  ],
  ...
  countryOfOriginStatement: [
    {
      "@value": "Produit en Belgique, pressé dans le Hainaut",
      "@language": "fr",
    },
  ],
  countryOfOrigin: [
  ...
  hasAllergen: [
    {
      allergenLevelOfContainmentCode: {
        "@id": "gs1:LevelOfContainmentCode-FREE_FROM",
      },
      allergenType: {
